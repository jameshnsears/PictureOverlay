package com.github.jameshnsears.pictureoverlay.utility
...
open class ScreenshotTestUtility : com.github.jameshnsears.pictureoverlay.utility.CommonTestUtility() {
    @get:Rule
    ...
    protected fun saveScreenshotToInternalStorage(fileName: String, bitmap: Bitmap) {
        // /data/data/com.github.jameshnsears.pictureoverlay/files/
