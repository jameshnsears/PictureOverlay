...
import com.github.jameshnsears.pictureoverlay.model.photo.repository.mediastore.MediaStoreRepository
import com.github.jameshnsears.pictureoverlay.utility.MediaStoreTestUtility
...
class CoilTest : com.github.jameshnsears.pictureoverlay.utility.CommonTestUtility() {
    @Before
    fun setUp() {
    ...
    fun getDrawableFromHttpEndpoint() = runTest {
        val httpEndpointUtility =
            com.github.jameshnsears.pictureoverlay.model.photo.card.HttpEndpointTestUtility()
